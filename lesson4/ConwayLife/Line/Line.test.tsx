...
describe("Line", () => {
    it("Render", () => {
        ...
        let wrapper = mount(<Line cells={cells1} cellSize={10} onClick={() => {}} cellAnimationDelay={50}/>);
        ...
        wrapper = mount(<Line cells={cells2} cellSize={10} onClick={() => {}} cellAnimationDelay={50}/>);
        expect(wrapper.find(".cell").length).toBe(3);
    });
    it("click", () => {
        const onClick = jest.fn();
        const wrapper = mount(<Line cells={[true, false]} cellSize={10} onClick={onClick} cellAnimationDelay={50}/>);
