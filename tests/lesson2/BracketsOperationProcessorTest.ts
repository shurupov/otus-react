...
describe("BracketsOperationProcessor performOperation method", () => {
    it("sin(30)", () => {
        expect(processor.performOperation(Operation.SIN, [30])).toEqual(Math.sin( 30 * Math.PI / 180));
    });
    it("tg(30)", () => {
        expect(processor.performOperation(Operation.TG, [30])).toEqual(Math.tan( 30 * Math.PI / 180));
    });
    it("ctg(30)", () => {
        expect(processor.performOperation(Operation.CTG, [30])).toEqual(1 / Math.tan( 30 * Math.PI / 180));
    });
    it("cos(30)", () => {
        expect(processor.performOperation(Operation.COS, [30])).toEqual(Math.cos( 30 * Math.PI / 180));
    });
    it("trunc(4.5)", () => {
