...
describe("TwoArgumentsOperationProcessor performOperationMethod method", () => {
    ...
    it("Multiplication 8 - 6", () => {
        expect(processor.performOperation(operations.SUBTRACTION, [8, 6])).toEqual(2);
    });
    it("Multiplication 8 * 6", () => {
        expect(processor.performOperation(operations.MULTIPLICATION, [8, 6])).toEqual(48);
    });
    it("Multiplication 25 / 10", () => {
        expect(processor.performOperation(operations.DIVISION, [25, 10])).toEqual(2.5);
    });
